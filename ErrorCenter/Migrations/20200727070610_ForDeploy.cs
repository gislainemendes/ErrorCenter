    ...
    public partial class ForDeploy : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    log_description = table.Column<string>(nullable: false),
                    number_of_events = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_frequency", x => x.log_description);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ip_origin = table.Column<string>(maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_error_frequency_LogDescription",
                        column: x => x.LogDescription,
                        principalTable: "frequency",
                        principalColumn: "log_description",
                        onDelete: ReferentialAction.Cascade);
                });
